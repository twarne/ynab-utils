...
public class MonthDetail {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(month, note, income, budgeted, activity, toBeBudgeted, ageOfMoney, deleted, categories);
  }
  ...
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!MonthDetail.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `MonthDetail` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

...
public class SaveTransactionWithId {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, saveTransactionWithId.id) &&
        Objects.equals(this.accountId, saveTransactionWithId.accountId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, accountId, date, amount, payeeId, payeeName, categoryId, memo, cleared, approved, flagColor, importId, subtransactions);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SaveTransactionWithId
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SaveTransactionWithId.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SaveTransactionWithId.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SaveTransactionWithId` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

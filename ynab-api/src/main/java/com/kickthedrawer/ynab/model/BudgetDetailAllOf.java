...
public class BudgetDetailAllOf {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(accounts, payees, payeeLocations, categoryGroups, categories, months, transactions, subtransactions, scheduledTransactions, scheduledSubtransactions);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!BudgetDetailAllOf.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `BudgetDetailAllOf` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
